            ...
            <div className="col no-border am-list-bg-none">
              <List  className="selectable text-left">
                <InputItem
                  ...
                  value={amountS}
                  extra={
                    <div className="fs14 cursor-pointer zb-b-l color-black-1 center-center w-75 bg-primary" style={{textAlign:'justify',position:'absolute',right:0,top:'0',bottom:'0',margin:'auto'}} >
                ...
                <InputItem
                  ...
                  value={amountB}
                  extra={
                    <div onClick={showLayer.bind(this,{id:"helperOfTokens",side:'buy'})} className="fs14 cursor-pointer text-justify zb-b-l color-black-1 center-center w-75 bg-primary" style={{textAlign:'justify',position:'absolute',right:0,top:'0',bottom:'0',margin:'auto'}} >
                        {p2pOrder.tokenB}
