  ...
  return (
    <div className="fs20 bg-white" style={{height:"100%",overflow:'auto' }}>
      ...
      <div className="zb-b-b p15">
        <div className="fs14 color-black-1 mb5 text-left">{intl.get('helper_of_price.sell_price', {token:tokenS})}</div>
      ...
      <div className="zb-b-b p10">
        <div className="fs14 color-black-1 mb5 text-left">{intl.get('helper_of_price.buy_price', {token:tokenB})}</div>
        <div className="fs14 color-black-3 lh20 text-left">
