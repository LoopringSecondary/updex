            ...
            <InputItem
              ...
              extra={
                <div className="fs14 cursor-pointer color-black-3 zb-b-l d-flex align-items-center justify-content-center" style={{width:'6.5rem',position:'absolute',right:0,top:'0',bottom:'0',margin:'auto'}} >
                  ...
                  <div hidden={side !== 'sell'} onClick={showAmountHelper} className="text-primary cursor-pointer text-right pr10 text-nowrap" style={{position:'absolute',top:'1rem',width:'3rem',left:'-3rem'}}>
