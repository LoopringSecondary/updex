...
export default {
  ...
  p2p_order: {
    ...
    frozen_balance_not_enough:'There has {amount}{token} in your available order(market and P2P orders), your balance is not enough when added to current order',
