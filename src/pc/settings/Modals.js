...
export function SetLanguageModal(){
  return (
    <Containers.Layers id="setLanguage">
      <UiContainers.Drawer id="setLanguage" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetLanguage />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
...
export function SetCurrencyModal(){
  return (
    <Containers.Layers id="setCurrency">
      <UiContainers.Drawer id="setCurrency" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetCurrency />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
...
export function SetLayoutModal(){
  return (
    <Containers.Layers id="setLayout">
      <UiContainers.Drawer id="setLayout" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetLayout />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
...
export function SetLRCFeeModal(){
  return (
    <Containers.Layers id="setLRCFee">
      <UiContainers.Drawer id="setLRCFee" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetLRCFee />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
...
export function SetThemeModal(){
  return (
    <Containers.Layers id="setTheme">
      <UiContainers.Drawer id="setTheme" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetTheme />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
...
export function SetTTLModal(){
  return (
    <Containers.Layers id="setTTL">
      <UiContainers.Drawer id="setTTL" position="right" style={{margin:'0 auto',height:'100%',width:'20vw'}}>
        <SetTTL />
      </UiContainers.Drawer>
    </Containers.Layers>
  )
