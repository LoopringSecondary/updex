...
const TickerItem = connect(({sockets:{tickers}})=>({tickers}))(({tickers,dispatch})=>{
  ...
  return (
      <div className="row ml0 mr0 no-gutters align-items-stretch fs18 text-number" style={{height:'100%'}}>
        <div onClick={toggleLayer.bind(this,'SidebarOfMarkets')} className="cursor-pointer col-auto zb-b-r bg-primary-light hover-bg-primary d-flex align-items-center" >
           <div className={`pl20`}>
