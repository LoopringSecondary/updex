        ...
        <tbody className="text-number">
            <tr className=""><td className="lh10 pt5" colSpan="10"></td></tr>
            {
              trades.items && trades.items.map((item,index)=>{
                ...
                return (
                  <tr key={index}>
                    <td className="border-none pl15 pr5 text-left align-middle cursor-pointer hover-default lh20" onClick={changePrice.bind(this,toNumber(item.price.toFixed(8)))}>
                      {
                    ...
                    <td className="border-none pl5 pr5 color-black-2 text-right align-middle text-nowrap cursor-pointer  hover-default lh20" onClick={changeAmount.bind(this,toNumber(item.amount.toFixed(4)))}>
                      {item.amount.toFixed(4)}
                    </td>
                    <td hidden className="border-none pl5 pr5 text-right color-black-2 align-middle text-nowrap lh20">
                      {item.lrcFee}
                    </td>
                    <td className="border-none pl5 pr15 color-black-2 text-right align-middle text-nowrap lh20">
